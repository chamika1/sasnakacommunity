...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO coordinators (name, email, phone, whatsapp, address, join_date, password) 
            VALUES (?, ?, ?, ?, ?, ?, ?)";
    
    try {
        $stmt = $pdo->prepare($sql);
        $stmt->execute([$name, $email, $phone, $whatsapp, $address, $join_date, $password]);
    ...
    <div class="register-container">
        ...
        <div class="register-card card">
            ...
            <form method="POST" action="" class="register-form">
                ...
                <button type="submit" class="btn btn-primary register-btn">Register as Coordinator</button>
            </form>
